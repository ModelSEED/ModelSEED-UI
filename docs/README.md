...
| **Atom Mapping** | [ATOM_MAPPING.md](./ATOM_MAPPING.md) | The `atom_mapping_data` grammar, InChI-orbit colour precision ladder, structures-core coverage, and the remaining server contract for unique atom identity. |
