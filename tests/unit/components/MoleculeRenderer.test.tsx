...
const getMol = vi.fn(() => ({
    ...
    get_svg: () => "<svg><path class='bond-0 atom-0 atom-1' style='stroke:#000000' /></svg>",
    get_svg_with_highlights: () => "<svg><path class='bond-0 atom-0 atom-1' style='stroke:#000000' /></svg>",
    delete: vi.fn(),
}));
