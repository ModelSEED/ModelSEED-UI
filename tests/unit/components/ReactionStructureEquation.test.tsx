...
const compounds = new Map([
    ['cpd00001', { name: 'Water', smiles: 'O', formula: 'H2O', charge: 0 }],
    ['cpd00012', { name: 'Phosphate donor', smiles: 'OP(=O)(O)O', formula: 'H4O7P2', charge: -2 }],
    ['cpd00009', { name: 'Phosphate', smiles: 'OP(=O)(O)O', formula: 'H3O4P', charge: -1 }],
]);
